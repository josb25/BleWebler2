...
>
    <header
        ...
        class:unified-editor-header={view === 'editor' && !templateUse && tplSheet === 'design'}
    >
        ...
        {:else if view === 'editor' || view === 'print'}
            ...
            {#if view === 'editor' && tplSheet === 'design'}
    ...
    <!-- Desktop: the active tool's options bar. The command menu lives in the
         unified header above; mobile keeps its bottom drawer. -->
...
<style>
    ...
    @media (min-width: 860px) {
        ...
        .unified-editor-header .desktop-menu {
            display: block;
            flex: 0 0 auto;
        }
        .unified-editor-header .menu-owned-action {
            display: none;
        }
        .unified-editor-header .name {
            flex: 1 1 120px;
            max-width: 360px;
            margin-left: 6px;
            padding: 6px 8px;
    ...
    @media (min-width: 860px) and (max-width: 1199px) {
        ...
        .unified-editor-header .save-state,
        .unified-editor-header .status-chevron {
            display: none;
        }
        .unified-editor-header .chip {
            padding-inline: 8px;
